...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <div class="container flex flex-wrap justify-between items-center mx-auto">
    ...
    <img class="mx-auto h-16 w-auto" src="https://user-images.githubusercontent.com/79155600/148837539-8c83a2c4-1cf4-4630-8e52-6bd7c61ecd12.png" alt="Workflow">
      <span class="self-center text-3xl font-semibold whitespace-nowrap dark:text-white ">JOBFINDR</span>
    </a>
    ...
    <div class="hidden w-full md:block md:w-auto" id="mobile-menu">
      <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
        ...
        @else 
        <li>
          <a href="/jobs" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Jobs</a>
        </li>
        <li>
          <a href="/jobs/create" class="block py-2 pr-4 pl-3 text-gray-700 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Create Listing</a>
        </li>
        <li>
